...
class Encode {
    ...
    map(field) {
        ...
        const f = `this.${field.name}`;
        const type = (0, type_info_js_1.getTypeInfo)(field);
        const sizeMethodName = `__sizeMapEntry_${(0, internal_js_1.relativeName)((_a = type.keyTypeInfo) === null || _a === void 0 ? void 0 : _a.typeName)}_${(0, internal_js_1.relativeName)((_b = type.valueTypeInfo) === null || _b === void 0 ? void 0 : _b.typeName)}`;
