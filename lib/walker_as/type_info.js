    ...
    switch (type.kind) {
        ...
        case "field_elementary_repeated": {
            ...
            if (type.kind == "field_elementary") {
                return Object.assign(Object.assign({}, elementaryBase), { default: defaults.get(type.type) });
            }
            return Object.assign(Object.assign({}, elementaryBase), { collectionTypeName: `Array<${typeName}>` });
        }
        case "field_message":
